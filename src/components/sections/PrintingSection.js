...
class PrintingSection extends Component {
  ...
  render() {
    ...
    const content = {
      ...
      [language.FINNISH]: <div><p>Kerhollamme on käytössä ammattitason Epson Stylus Pro 3880 valokuvatulostin, jolla voit tulostaa aina A2 kokoon asti. Merkkaathan piikkilistaan tulosteesi. Tarkemmat käytännön ohjeet <a href={printing}>täältä</a>.</p><p>Lisäksi meiltä löytyy laminointikone. Koneella voi laminoida aina A3 kokoon saakka ja kerholta löytyy myytäväksi muutamaa eri arkkikokoa.</p></div>
    }
